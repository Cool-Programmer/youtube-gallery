		...
		?>
			<div class="wrap video-form">
				<div class="form-group">
					<label for="video-id"><?php esc_html_e('Video ID', 'yg'); ?></label>
				...
				<div class="form-group">
					<label for="details"><?php esc_html_e('Details', 'yg'); ?></label>
					<?php
				...
				<?php if (isset($yg_video_stored_meta['video_id'][0])): ?>
					<iframe width="560" height="315" src="https://www.youtube.com/embed/<?php echo esc_attr($yg_video_stored_meta['video_id'][0]); ?>" frameborder="0"></iframe>			
				<?php endif; ?>
			</div>
		<?php
	}
